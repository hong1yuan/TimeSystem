...
<html lang="en" class="no-js">
    ...
    <body style="background:url(/Public/Admin/img/backgrounds/bjt.jpg) no-repeat;background-position:center; background-size:auto; ">

        <div class="page-container clearfix">
            <h1 style="color: #000000; font-family:"Microsoft YaHe"; font-weight: normal;">洲际财富系统</h1>
            ...
            <form action="" method="post">
                ...
                <div class="mima">
                    <span id="pwd" Style=" font-family:微软雅黑">密码：</span>
