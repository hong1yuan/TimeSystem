        ...
        <div class="admin-content-body">
            ...
            <div class="am-g">
                ...
                <div class="am-u-sm-12 am-u-md-10 am-u-md-pull-2">
                    <form class="am-form am-form-horizontal" onSubmit="return chkForm()" method="POST" action="/index.php/Admin/Caiwu/exchange.html">
                        ...
                        <div class="am-form-group">
                            <label for="zhoujibi" class="am-u-sm-3 am-form-label">转出数目</label>
                            <div class="am-u-sm-9">
