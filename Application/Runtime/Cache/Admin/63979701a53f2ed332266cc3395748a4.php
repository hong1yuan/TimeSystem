        ...
        <div class="admin-content-body">
            ...
            <div class="am-g">
                ...
                <div class="am-u-sm-12 am-u-md-10 am-u-md-pull-2">
                    <form class="am-form am-form-horizontal" method="post" action="<?php echo U('up');?>">
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">接收会员</label>
                            <div class="am-u-sm-9">
                                <input type="text" id="user-name" placeholder="请输入接收会员的账号">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" id="user-money" placeholder=" " value="100">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" id="user-pwd" placeholder="请输入二级密码 ">
                            </div>
                        </div>

                        <div class="am-form-group">
                            <div class="am-u-sm-9 am-u-sm-push-3">
                               <!-- <button type="button" class="am-btn am-btn-primary"           >确认转账</button><br/>-->
