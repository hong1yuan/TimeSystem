                    ...
                    <form class="am-form">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <?php if(is_array($news_list)): foreach($news_list as $key=>$v): ?><tr>
                                ...
                                <td><a href="<?php echo U('chakannews',array('id'=>$v['newsid']));?>"><?php echo ($v["title"]); ?></a></td>
                                <td class="am-hide-sm-only"><?php echo ($v["updatetime"]); ?></td>
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a href="<?php echo U('editnews',array('id'=>$v['newsid']));?>" class="am-btn am-btn-default am-btn-xs am-text-secondary">
                                                <span class="am-icon-pencil-square-o"></span>
                                                修改
                                            </a>
                                            <a href="<?php echo U('zhiting',array('id'=>$v['newsid']));?>" class="am-btn am-btn-default am-btn-xs am-text-secondary">
                                                <span class="am-icon-pencil-square-o"></span>
                                                置顶
                                            </a>
                                            <a href="<?php echo U('del',array('id'=>$v['newsid']));?>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="return confirm('你确定要删除吗');">
