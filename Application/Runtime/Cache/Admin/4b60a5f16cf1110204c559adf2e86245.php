                ...
                <div class="am-u-sm-12">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <tr>
                                ...
                                <th class="table-title" style="width:10%;">用户名</th>
                                <th class="table-type" style="width:20%;">充值金额</th>
                                <th class="table-author am-hide-sm-only" style="width:20%;">余额</th>
                                <th class="table-set" style="width:20%;">充值时间</th>
                            ...
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                    ...
                                    <td class="am-hide-sm-only">€<?php echo ($vo["xianjin"]); ?></td>
                                    ...
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs status">
                                                ...
                                                <?php else: ?> 
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary cash"  cid="<?php echo ($vo["id"]); ?>"><span class="am-icon-pencil-square-o"></span>未处理</button><?php endif; ?>
...
<script type="text/javascript">
    ...
    $('.cash').on('click',function(){
        ...
        var self = $(this);
        layer.confirm('您确定该用户已充值成功吗？', {
          btn: ['确定','取消'] //按钮
        }, function(){
            $.get('remit?cid='+cid,function(data){
                layer.closeAll();
