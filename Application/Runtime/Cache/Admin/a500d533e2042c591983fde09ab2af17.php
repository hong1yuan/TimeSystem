    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新闻管理</strong> / <small>新闻公告</small></div>
            </div>
	                                ...
	                                <td>
	                                    <div class="am-btn-toolbar">
	                                        <div class="am-btn-group am-btn-group-xs">
	                                            <a href="<?php echo U('chakannews',array('id'=>$vo['newsid']));?>" class="am-btn am-btn-default am-btn-xs am-text-secondary">
