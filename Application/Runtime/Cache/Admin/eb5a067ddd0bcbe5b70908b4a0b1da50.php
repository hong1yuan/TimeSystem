    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">财务管理</strong> / <small>分发周利息</small></div>
            </div>
            <hr>
            <div class="am-g">
                ...
                <div class="am-u-sm-12 am-u-md-10 am-u-md-pull-2">
                    <form class="am-form am-form-horizontal" method="POST" action="/Admin/Guanli/fenfa2" onsubmit="return chcForm();">
                        <?php if(is_array($lists)): foreach($lists as $k=>$v): ?><div class="am-form-group">
                            <label  class="am-u-sm-3 am-form-label">
                                <?php echo ($v["jibie"]); ?>
                            </label>
                            <div class="am-u-sm-9">
                                <input type="text" class="user-jibie"  name="<?php echo ($v["id"]); ?>" value="<?php echo ($v["zlixi"]); ?>" />
