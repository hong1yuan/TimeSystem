        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf">
                    <strong class="am-text-primary am-text-lg">财务管理</strong>
                    / <small>财务明细</small></div>
            </div>
            <!--<div class="am-g">
               ...
               &lt;!&ndash; <div class="am-u-sm-12 am-u-md-3">
                ...
                <div class="am-u-sm-12">
                    <form class="am-form">
                        <table class="am-table am-table-striped am-table-hover table-main"  >
                            <thead>
                            <tr>
                                <!--<th class="table-check" width="2%">
                                    <input type="checkbox" />
                                </th>-->
                                <th class="table-id" width="9%">编号</th>
                                <th class="table-title" width="25%">日期</th>
                                <th class="table-type" width="45%">财务项目</th>
                                <th class="table-author am-hide-sm-only" width="21%">金额</th>
                      ...
                      <!-- <div class="am-cf">
                            ...
                            <div class="am-fr">
                                <ul class="am-pagination">
                                    ...
                                    <?php $__FOR_START_26041__=1;$__FOR_END_26041__=$pages+1;for($i=$__FOR_START_26041__;$i < $__FOR_END_26041__;$i+=1){ ?><li
                                            <?php if( $page == $i): ?>class="am-active"
                                                <?php else: endif; ?>
                                    ><a href="<?php echo U('index',array('p'=>$i));?>"><?php echo ($i); ?></a></li><?php } ?>
                                    <li><a href="<?php echo U('index',array('p'=>$prev));?>">»</a></li>
                                </ul>
                            </div>
                           <?php echo ($show); ?>
                        </div>-->
