...
<head>
    ...
    <link rel="icon" type="image/png" href="/ww/Public/Admin/i/favicon.png">
    <link rel="apple-touch-icon-precomposed" href="/ww/Public/Admin/i/app-icon72x72@2x.png">
    <meta name="apple-mobile-web-app-title" content="Amaze UI" />
    <link rel="stylesheet" href="/ww/Public/Admin/css/amazeui.min.css"/>
    <link rel="stylesheet" href="/ww/Public/Admin/css/admin.css">
    <link rel="stylesheet" href="/ww/Public/Admin/lib/layer/skin/layer.css">
</head>
<body>
<!--[if lte IE 9]>
...
<header class="am-topbar am-topbar-inverse admin-header">
    <div class="am-topbar-brand">
        <div class="logo"><img class="am-img-responsive" src="/ww/Public/Admin/i/examples/logo.png"></div>
...
<script type="text/javascript" charset="utf-8" src="/ww/Public/plugin/ueditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/ww/Public/plugin/ueditor/ueditor.all.min.js"> </script>
<script type="text/javascript" charset="utf-8" src="/ww/Public/plugin/ueditor/lang/zh-cn/zh-cn.js"></script>
        ...
        <div class="admin-content-body">
            ...
            <div class="am-g">
                <div class="am-u-sm-12">
                    <form class="am-form" action="editok" method="post" enctype="multipart/form-data">
                        <h3>标题</h3>
                        <input type="text" value="" name="title"/>
                        <h3>内容</h3>
                        <textarea id="contents" name="contents" style="height:200px;">
...
<!--[if lt IE 9]>
<script src="/ww/Public/Admin/js/jquery.min.js"></script>
<script src="/ww/Public/Admin/js/modernizr.js"></script>
<script src="/ww/Public/Admin/js/amazeui.ie8polyfill.min.js"></script>
<![endif]-->

<!--[if (gte IE 9)|!(IE)]><!-->
<script src="/ww/Public/Admin/js/jquery.min.js"></script>
<!--<![endif]-->
<script src="/ww/Public/Admin/js/amazeui.min.js"></script>
<script src="/ww/Public/Admin/js/app.js"></script>
<script src="/ww/Public/Admin/lib/laypage/laypage.js"></script>
<script src="/ww/Public/Admin/lib/layer/layer.js"></script>
<!-- <script type="text/javascript" src="/ww/Public/Admin/lib/ueditor/ueditor.config.js"></script>
<script type="text/javascript" src="/ww/Public/Admin/lib/ueditor/ueditor.all.js"></script> -->
<!-- <script type="text/javascript" src="/ww/Public/Admin/js/dialog.js"></script> -->
</body>
</html>
<script type="text/javascript">
    ...
    var ue = UE.getEditor('contents',{toolbars: [[
