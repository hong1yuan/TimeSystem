    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改二级密码</strong> / <small>password</small></div>
            </div>
            ...
            <div class="am-g">
                ...
                <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                    <form class="am-form am-form-horizontal" id="dify"  method="post">
                        ...
                        <br/>
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">旧二级密码</label>
                            <div class="am-u-sm-9">
                        ...
                        <br/>
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">新二级密码</label>
                            <div class="am-u-sm-9">
...
<script type="text/javascript">
 ...
 function submitAdd(){
      ...
      $('#dify').attr("action","paypasswordup");
      $('#dify').submit();
