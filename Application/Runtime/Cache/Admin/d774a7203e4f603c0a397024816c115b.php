            ...
            <div class="am-g">
                <div class="am-u-sm-12">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            <thead>
                            <tr>
                               <th class="table-id">序号</th><th class="table-title"> 会员编号 </th><th class="table-type">推荐人</th><th class="table-author am-hide-sm-only">注册时间</th><th class="table-date am-hide-sm-only"> 开通时间 </th><th class="table-set">状态</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php if(is_array($news_list)): foreach($news_list as $key=>$vo): ?><tr>
                                ...
                                <td class="am-hide-sm-only"><?php echo ($vo["regtime"]); ?></td>
                                <td class="am-hide-sm-only"><?php echo ($vo["passtime"]); ?></td>
                                <td>
                                    <?php if($vo["ispay"] == 0): ?><div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <button class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="activet(<?php echo ($vo["id"]); ?>)"><span class="am-icon-pencil-square-o"></span> 激活</button>
                                            <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o" onclick="del(<?php echo ($vo["id"]); ?>)"></span> 删除</button>
                                        </div>
                                    </div><?php else: ?><strong>已激活</strong><?php endif; ?> 
